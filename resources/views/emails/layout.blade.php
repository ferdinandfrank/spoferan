                                                                ...
                                                                <tr>
                                                                    <td align="center" class="subtitle"
                                                                        ...
                                                                        <span class="apple-override-header"
                                                                                    style="color: #ffffff; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 20px; line-height: 22px;">@yield('title')</span>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                ...
                                <td align="center"
                                    ...
                                    <table class="width" border="0" cellpadding="0" cellspacing="0" width="500">
                                        ...
                                        <tr>
                                            ...
                                            <td align="{{ isset($receiptNumber) ? 'left' : 'center' }}" class="subbanner-item font-small"
                                    ...
                                    <span class="apple-override-header"
                                        ...
                                        {{ \Carbon\Carbon::now()->formatLocalized('%d %B %Y') }}
                                            ...
                                            <td align="right" class="subbanner-item font-small"
                                                ...
                                                width="230">
                                                <span class="apple-override-header"
                                                      style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly; color: #ffffff; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 13px; line-height: 17px; text-shadow: 0 1px 1px #007500;">{{ $receiptNumber }}</span>
                                            </td>
                                            @endif
                                            <td class="perm-padding"
                                                style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr class="summary-item">
                                            <td align="left" class="font-medium"
                                                style="border: 0; margin: 0; padding: 0; color: #525252; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 17px; font-weight: normal; line-height: 17px;"
                                                width="100%">
                                                <span class="apple-override-dark"
                                                      style="border: 0; margin: 0; padding: 0;">@yield('greeting')</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="summary-item">
                                            <td align="left" class="font-medium"
                                                style="border: 0; margin: 0; padding: 0; color: #525252; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 20px;"
                                                width="100%">
                                                <span class="apple-override-dark"
                                                      style="border: 0; margin: 0; padding: 0;">@yield('text')</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="summary-item">
                                            <td align="left" class="font-medium"
                                                style="border: 0; margin: 0; padding: 0; color: #525252; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 17px;"
                                                width="100%">
                                                <span class="apple-override-dark"
                                                      style="border: 0; margin: 0; padding: 0;">@yield('salutation')</span>
                                            </td>
                                        </tr>
                                        <tr class="summary-item">
                                            <td align="left" class="font-medium"
                                                ...
                                                width="100%">
                                                <span class="apple-override-dark"
                                                      style="border: 0; margin: 0; padding: 0;">{{ Settings::title() }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr class="summary-item">
                                            ...
                                            <td align="left" class="font-small"
                                                style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; color: #77858c; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 12px; font-weight: bold; line-height: 20px;"
                                                width="100%">
                                                Description
                                            </td>
                                        ...
                                        <tr class="summary-item">
                                            ...
                                            <td align="left" class="font-medium"
                                                style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; color: #525252; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: normal; line-height: 17px;"
                                                width="100%">
                                                <span class="apple-override-dark"
                                                      style="border: 0; margin: 0; padding: 0;">Charge Description</span>
                                            </td>
                                            <td style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px;"
                                                width="10">
                                                <div class="clear" style="height: 1px; width: 10px;"></div>
                                            ...
                                            <td colspan="5" align="right"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" class="width"
                                                    ...
                                                    <tr class="summary-item">
                                                        ...
                                                        <td align="left"
                                                            style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; color: #525252; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 12px; font-weight: bold; line-height: 17px;"
                                                            width="100">
                                                            Total
                                                        </td>
                                                        <td style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px;"
                                                        ...
                                                        <td align="right" class="summary-total width"
                                                            style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; color: #525252; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 17px;"
                                                            width="208">
                                                            $19.99
                                                        </td>
                                                        <td class="summary-padding"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="width" width="500">
                            ...
                            <tr>
                                ...
                                <td align="center" class="font-large"
                                    style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; color: #515f66; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 15px; line-height: 21px;">

                                    {{ trans('email.any_questions') }} <a href="mailto:{{ Settings::contactEmail() }}"
                                                                     style="border: 0; margin: 0; padding: 0; color: #515f66; font-family: 'Folks', Helvetica, Arial, sans-serif; text-decoration: none;"
                                                                     target="_blank" rel="noreferrer"><span
                                                style="border: 0; margin: 0; padding: 0; color: #008200; text-decoration: none;">{{ trans('action.send_us_an_email') }}</span></a>.
                                </td>
                                <td style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;">
                                    <div class="clear" style="height: 1px; width: 20px;"></div>
                                </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="width" width="500">
                            ...
                            <tr>
                                ...
                                <td align="center" class="font-small"
                                    style="border: 0; margin: 0; padding: 0; color: #959fa5; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 13px; line-height: 17px;">
                                    @yield('receiving_info')
                                </td>
                                <td class="perm-padding"
                                    style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px;"
                                    width="20">
                            ...
                            @if(View::hasSection('action'))
                                <tr>
                                    ...
                                    <td align="center" class="font-small"
                                        style="border: 0; margin: 0; padding: 0; color: #959fa5; font-family: 'Folks', Helvetica, Arial, sans-serif; font-size: 13px; line-height: 17px;">
                                        {{ trans('email.button_help') }} <a href="" style="border: 0; margin: 0; padding: 0; color: #008200; font-family: 'Folks', Helvetica, Arial, sans-serif; text-decoration: none;"
                                                                                                       target="_blank"
                                                                                                       rel="noreferrer">{{ $link ?? '' }}<span
                                                    style="border: 0; margin: 0; padding: 0; color: #008200; text-decoration: none;"></span></a>.
                                    </td>
                                    <td class="perm-padding"
                                        style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px;"
                                        width="20">
