        ...
        <div slot="header" class="action">
            ...
            @else
                ...
                <span class="icon is-small">
                    ...
                    <span>{{ $participationClass->getParticipationRestriction()['msg'] }}</span>
                </a>
            @endif
        </div>
        ...
        <div class="column">
            ...
            <ul class="info-list">
                ...
                @if(!empty($participationClass->restr_birth_date_min))
                        <li><b>{{ trans('label.min_age') }}:</b>&nbsp;{{ $participationClass->restr_birth_date_min->age }} ({{ dateDiffForHumans($participationClass->restr_birth_date_min, false) }})</li>
                @endif
                @if(!empty($participationClass->restr_birth_date_max))
                        <li><b>{{ trans('label.max_age') }}:</b>&nbsp;{{ $participationClass->restr_birth_date_max->age }} ({{ dateDiffForHumans($participationClass->restr_birth_date_max, false) }})</li>
                @endif
